...
public class SchedulerPage extends BasePage {
    ...
    private By chooseTime = By.xpath("//fieldset[@id='w1']/div[12]/div/div/div/span/span/span/ul/li/input");
 ...
 /*   public SchedulerPage activateCheckBoxRetentionUsers(){
        WebElement search1= wait.until(ExpectedConditions.visibilityOfElementLocated(checkBoxReturnUsers));
                search1.click();
        return this;
    }*/
